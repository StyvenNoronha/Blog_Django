...
DATABASES = {
    'default': {
        ...
        'NAME': config('POSTGRES_DB',default="change-me"),
        'USER': config('POSTGRES_USER',default="change-me"),
        'PASSWORD': config('POSTGRES_PASSWORD',default="change-me"),
        'HOST': config('POSTGRES_HOST',default="change-me"),  
        'PORT': config('POSTGRES_PORT',default="change-me"),     
    }
}
